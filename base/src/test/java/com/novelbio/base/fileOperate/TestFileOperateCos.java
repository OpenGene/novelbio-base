...
public class TestFileOperateCos {
	...
	public void testGetPath() {
		Path path = FileOperate.getPath("cos://novelbrain-1255651097/aaa/bbb.txt");
	...
	public void testGetLsFoldFileName() {
		Path path = FileOperate.getPath("cos://novelbrain-1255651097/");
...
//		Path path1 = FileOperate.getPath("cos://novelbrain-1255651097/aaa/bbb.txt");
//		Path path2 = FileOperate.getPath("cos://novelbrain-1255651097/aaa/ddd.txt");
