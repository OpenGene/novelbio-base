 ...
 *  for XSSF.
 *  
 *  update by fans.fan 160331. 修改poi-ooxml*.jar下源码,增加了一个getSheets方法.
 */
public class XSSFReader {
     ...
     */
    public PackageRelationshipCollection getSheets() throws InvalidFormatException{
    	 return workbookPart.getRelationshipsByType(XSSFRelation.WORKSHEET.getRelation());
    }
