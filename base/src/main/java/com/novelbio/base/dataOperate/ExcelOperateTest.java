 ...
 * Zong Jie修改
 */
public class ExcelOperateTest implements Closeable {
	 ...
	 * @param imputfilename
	 */
	public ExcelOperateTest(String imputfilename) {
	...
	public ExcelOperateTest(String imputfilename, boolean excel2003) {
