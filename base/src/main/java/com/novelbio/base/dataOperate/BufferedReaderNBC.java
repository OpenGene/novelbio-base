...
/** 与bufferedReader几乎一模一样，
 * 除了在readline的地方设定了一行最长不能超过 100000，否则就抛出异常
 */
public class BufferedReaderNBC extends BufferedReader {
	 ...
	 *                If {@code sz <= 0}
	 */
	public BufferedReaderNBC(Reader in, int sz) {
		super(in);
		if (sz <= 0)
	 ...
	 * @exception IOException
	 *                If an I/O error occurs
	 * @throws ExceptionNBCReadLineTooLong
	 *             if one line is too long, longer than MAX_LINE_NUM(default is
	 *             100000)
	 */
	 ...
	 * read only occurs during the <a
	 * href="../util/stream/package-summary.html#StreamOps">terminal stream
	 * operation</a>.
	 *
	 * <p>
