...
public class DoubleArrayTrieDart {
...
//		lsWords.add("天气还客气");
		...
		lsWords.add("bcdef");
		lsWords.add("bcdefg");
		DoubleArrayTrieDart dat = new DoubleArrayTrieDart();
		System.out.println("是否错误: " + dat.build(lsWords));
		System.out.println(dat);
		List<Integer> lsInfo = dat.commonPrefixSearch("bcdefgd");
